...
//			feedParentFolder = PATH_TO_FEED_PARENT_FOLDER +"period/";
...
//			feedParentFolder = PATH_TO_FEED_PARENT_FOLDER + "group/";
...
//			feedParentFolder = PATH_TO_FEED_PARENT_FOLDER + "ledger/";
...
//			feedParentFolder = PATH_TO_FEED_PARENT_FOLDER + "events/";
...
//		if(false){
	...
	private void searchForEntries(RSSRequest rssRequest, String feedParentFolder, String feedFileName, String extraURI) {
		IWContext iwc = getIWContext(rssRequest);
		...
		if (entries != null){
			...
			if (entries.isEmpty()){
				allArticles = rss.createNewFeed("No entries found", serverName , FEED_DESCRIPTION, "atom_1.0", iwc.getCurrentLocale().toString(), new Timestamp(now.getTime()));
				feedParentFolder = "/files/cms/calendar/rss/";
				feedFileName = "empty_"+iwc.getLocale().getLanguage()+".xml";		
			}
			else
				allArticles = rss.createNewFeed("title", serverName , FEED_DESCRIPTION, "atom_1.0", iwc.getCurrentLocale().toString(), new Timestamp(now.getTime()));
