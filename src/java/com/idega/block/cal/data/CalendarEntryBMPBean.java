...
//  }
  ...
  public Collection ejbFindEntryBetweenTimestamps(Timestamp fromStamp, Timestamp toStamp) throws FinderException{
  	...
  	System.out.println("[CalendarEntryBMPBean:findEntryBetweenTimestamps] "+query.toString());
  	return super.idoFindPKsByQuery(query);
  }
...
;  	return super.idoFindPKsByQuery(query);
  ...
  public Collection ejbFindEntriesByLedgersIds(List ledgersIds) throws Exception {
	  IDOQuery query = idoQueryGetSelect();	
  ...
  public Collection ejbFindEntriesByLedgerIdsOrGroupsIds(List ledgersIds, List groupsIds, Timestamp from, Timestamp to) throws FinderException {
