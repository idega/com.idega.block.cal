/**
 * @(#)ICalendarEventUtil.java    1.0.0 14:50:14
 *
...
/**
 * <p>Various conversions to ICalendar format</p>
 * <p>You can report about problems to: 
 * <a href="mailto:martynas@idega.is">Martynas Stakė</a></p>
 *
 * @version 1.0.0 2015 gruod. 29
 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
 */
public class ICalendarEventUtil {

	/**
	 * 
	 * @param entry to convert, not <code>null</code>;
	 * @return converted event to ICal4j format or <code>null</code> on failure;
	 */
	public static VEvent getEvent(CalendarEntry entry) {
		if (entry != null) {
			...
			try {
				...
				Logger.getLogger(ICalendarEventUtil.class.getName()).log(
						Level.WARNING, "Event parsing problem: ", e);
			}
	 ...
	 * @return converted entities or {@link Collections#emptyList()} on failure;
	 */
	public static List<VEvent> getEvents(Collection<CalendarEntry> entities) {
		ArrayList<VEvent> events = new ArrayList<VEvent>();

		if (!ListUtil.isEmpty(entities)) {
			for (CalendarEntry entity: entities) {
				VEvent event = getEvent(entity);
				if (event != null) {
					events.add(event);
				}
			}
